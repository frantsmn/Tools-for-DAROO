...
$("body").append("<style>#dkPanel, #hPanel, #sePanel, #pvPanel, #svPanel{height:auto; max-height:400px; max-width:900px; overflow: auto; background: white;" +
				 "border:solid 1px lightgray; box-shadow: 0px 0px 17px -1px rgba(0,0,0,0.5); border-radius:5px; padding:10px; z-index:9999 !important; margin-top:200px; margin-left:350px; /*margin-top:460px; margin-left:290px;*/ position:fixed; opacity:0.93;}"+
