...
class Parser {
	...
	parseDoc(text) {
		...
		let number = 0; //Порядковый номер контент-блока
		...
		strings.forEach(function (item, i) {
			switch (item) {
				case "dk-sh":
					...
					panel.addRezultRow(number, "dk", "Две колонки");
					number++;
					break;
				case "ci-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "ci", "Цитата");
					number++;
					break;
				case "pv-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "pv", "Преимущества/возможности");
					number++;
					break;
				case "ot-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "ot", "Подзаголовок/Обычный текст");
					number++;
					break;
				case "h-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "h", "Характеристики");
					number++;
					break;
				case "se-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "se", "Структура/этапы");
					number++;
					break;
				case "sv-sh":
					blocks.push({
					...
					panel.addRezultRow(number, "sv", "Сервисные возможности");
					number++;
					break;
			}
		});
...
//▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
//Класс пункта меню "Разобрать документ"
class Menu {
	constructor() {
		$("ul.top-nav").prepend(`
...
class Panel {
	constructor() {
		...
		$("body").prepend(`
			<div id='rezultPanel' class='content-block-panel'>
				<div class='first-row'>
		...
		//По drag'n'drop панели сохраняем координаты панели в базу
...
const blockConstructor = new BlockConstructor(); //Model

const menu = new Menu(); //Control
...
$("button.paste-meta-info-button").on("click", function () {
	if (getPageType("type") === "product") {
		...
		$("textarea#product_description_translations_ru_marketingDescription").css({
			...
			"height": "100px",
			"padding": "10px"
		}).val(meta.description_for_marketing);
	}
