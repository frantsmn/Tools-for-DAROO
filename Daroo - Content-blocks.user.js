...
$("body").append("<style>#dkPanel, #hPanel, #sePanel, #pvPanel, #svPanel{height:auto; max-height:400px; max-width:900px; overflow: auto; background: white;" +
				 ...
				 "#hideSave, #clearDk, #clearH, #clearSe, #clearPv, #clearSv, #closePanel{float: left; margin-right:10px;}"+
...
$("body").prepend("<div id=\"dkPanel\"><table><tr><td colspan=\"2\" align=\"center\"><input type=\"text\" id=\"dkTitle\" placeholder=\"Заголовок\" style=\"width:180px; text-align:center;\"></td></tr>"+
				  ...
				  "</table><div id=\"hideSave\" class=\"btn btn-primary\">Сохранить и закрыть</div> <div id=\"clearDk\" class=\"btn btn-primary\">Очистить</div> <div id=\"closePanel\" class=\"btn btn-primary\">Закрыть</div></div>");
$( "#dkPanel" ).draggable();
...
$( "body" ).prepend( "<div id=\"hPanel\"><table id=\"hTable\"><tr><td align=\"center\"><input type=\"text\" id=\"hTitle\" placeholder=\"Заголовок\" style=\"width:240px; text-align:center;\"></td></tr><tr class=\"h_right h_tr\"><td align=\"right\"><input type=\"text\" id=\"hSubtitle\" placeholder=\"Подзаголовок\"><br><textarea id=\"hDescText\" cols=\"20\" rows=\"5\" placeholder=\"Текст\"></textarea></td></tr></table><div id=\"hideSave\" class=\"btn btn-primary\">Сохранить и закрыть</div> <div id=\"clearH\" class=\"btn btn-primary\">Очистить</div> <div id=\"closePanel\" class=\"btn btn-primary\">Закрыть</div></div>");
$( "#hPanel" ).draggable();
...
$( "body" ).prepend( "<div id=\"sePanel\"><table style=\"padding-bottom:20px;\" id=\"seTable\"><tr><td align=\"center\"><input type=\"text\" id=\"seTitle\" placeholder=\"Заголовок\" style=\"text-align:center; width:240px;\"></td></tr><tr class=\"se_tr\"><td align=\"right\"><input type=\"text\" id=\"seSubtitle\" placeholder=\"Подзаголовок\"><br><textarea id=\"seDescText\" cols=\"20\" rows=\"5\" placeholder=\"Текст\"></textarea></td></tr></table><div id=\"hideSave\" class=\"btn btn-primary\">Сохранить и закрыть</div> <div id=\"clearSe\" class=\"btn btn-primary\">Очистить</div> <div id=\"closePanel\" class=\"btn btn-primary\">Закрыть</div></div>");
$( "#sePanel" ).draggable();
